  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate your business processes with HR Management Application - Your ultimate solution for efficient and seamless human resources management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Elevate your business processes with HR Management Application - Your ultimate solution for efficient and seamless human resources management.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Job Applicant" type="job-applicant" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
