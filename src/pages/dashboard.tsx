...
import { useRoqPlatformUserProfiles, useEmployeeCount, useJobApplicantCount, useOwnerCount } from 'lib/roq';

import { JobApplicantListPage as ShowCaseList } from 'pages/job-applicants';
...
function DashboardPage() {
  ...
  const jobApplicantStat = useJobApplicantCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: jobApplicantStat?.data,
      isLoading: jobApplicantStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Owners',
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`job-applicants`} passHref legacyBehavior>
                  <Button
