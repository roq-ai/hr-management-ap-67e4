...
export function useJobApplicantFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobApplicantFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_applicant.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobApplicantCount<T extends Prisma.job_applicantCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.job_applicantCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobApplicantCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_applicant.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobApplicantFindManyWithCount<
  T extends Prisma.job_applicantFindManyArgs,
  R extends { data: GetFindResult<Prisma.$job_applicantPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.job_applicantFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobApplicantFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_applicant.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobApplicantFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobApplicantFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_applicant.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
